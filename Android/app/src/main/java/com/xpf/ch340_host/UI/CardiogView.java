...
public class CardiogView extends View {
    ...
    public CardiogView(Context context, @Nullable AttributeSet attrs) {
        ...
        mColor = mTypedArray.getColor(R.styleable.CardiogView_linecolor, getResources().getColor(R.color.Red));
    ...
    private void init(){
        mPaint = new Paint();
        PathEffect mPathEffect = new CornerPathEffect(1.0f);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 1; i < points.size(); i++) {
            ...
            path.lineTo(x, y);
            canvas.drawCircle(x, y, 0.1f, mPointPaint);
        }
